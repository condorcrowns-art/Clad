...
defItem('jukebox',     { name: 'Jukebox', kind: 'block', tier: 3, hp: 8, solid: true, deco: true, animated: true, color: '#e63946', color2: '#ffd166', desc: 'DECOR: a glowing retro jukebox with dancing lights. Pure vibes.' });
defItem('aquarium',    { name: 'Aquarium', kind: 'block', tier: 3, hp: 6, solid: true, deco: true, animated: true, color: '#118ab2', color2: '#8ecae6', desc: 'DECOR: a bubbling fish tank with a little swimmer inside.' });
defItem('arcade_cab',  { name: 'Arcade Cabinet', kind: 'block', tier: 3, hp: 10, solid: true, deco: true, animated: true, color: '#3a2a6a', color2: '#6ee7ff', desc: 'DECOR: a retro arcade machine, screen flickering with a tiny game.' });
defItem('disco_ball',  { name: 'Disco Ball', kind: 'block', tier: 3, hp: 5, solid: false, deco: true, animated: true, color: '#cfd8e6', color2: '#c77dff', desc: 'DECOR: a spinning mirror ball that scatters coloured light.' });
